...
class ForgotPasswordPage extends BaseView<ForgotPasswordController>{
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Visibility(
                      ...
                      child: Text.rich(
                        TextSpan(
                          children: [
                            TextSpan(
                              text: "You can reset your password to entering your\n",
                    ...
                    Padding(
                      ...
                      child: GestureDetector(
                        onTap: (){
                          controller.reset.value = "password";
                          controller.isFill.value ? (controller.isViaEmail.value ? Get.toNamed(Routes.verify, arguments: [controller.isViaEmail.value, controller.phoneNumberText.value, controller.reset.value])
                              : Get.toNamed(Routes.verify, arguments: [controller.isViaEmail.value, controller.emailText.value, controller.reset.value])) : SnackBarUtil.showError(message: "Required missing field.");
                        },
                        child: Container(
                          width: Get.width,
                          height: 64.0,
                          ...
                          child: Center(child: Text("Next".tr, style: regularTextStyle(fontSize: dimen16, color: ColorsTheme.colWhite),)),
                        ),
                      ),
                    ),
                  ]),
