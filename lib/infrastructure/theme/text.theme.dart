...
extraLightTextStyle({required fontSize, required color, height,}) {
  return TextStyle(fontSize: fontSize, color: color, fontWeight: FontWeight.w200, height: height);
}
...
regularTextStyle({required fontSize, required color, height}) {
  return TextStyle(fontSize: fontSize, color: color, fontWeight: FontWeight.w400, height: height);
}
...
boldTextStyle({required fontSize, required color, height}) {
  return TextStyle(fontSize: fontSize, color: color, fontWeight: FontWeight.w700, height: height);
}
extraBoldTextStyle({required fontSize, required color, height}) {
  return TextStyle(fontSize: fontSize, color: color, fontWeight: FontWeight.w800, height: height);
}



appBarTextStyle({fontSize, required color}) {
  return TextStyle(fontSize: fontSize ?? dimen20, color: color, fontWeight: FontWeight.w700);
}
